...
runcodesniffer () {
    ...
    [[ -n $(vendor/bin/php-cs-fixer fix . --dry-run --verbose --fixers=$fixers) ]] || printf "Aucune violation de standard n'a été trouvée\n"
}
...
setenvironment () {
    ...
    cp -rvn --parent public/module/* ../../public/module
    cp -rvn --parent public/vendor/* ../../public/vendor
}
...
setdevelopment () {
    ...
    cp -vf public/dztask.php ../../public
    cp -vf public/dztask.test.php ../../public

    chmod -v 644 ../../public/dztask.php
    chmod -v 644 ../../public/dztask.test.php
}
...
setproduction () {
    ...
    rm -vf ../../public/dztask.php
    rm -vf ../../public/dztask.test.php
}
