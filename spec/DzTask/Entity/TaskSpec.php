 ...
 * @link     https://github.com/dieze/DzTask/blob/master/spec/DzTask/Entity/TaskSpec.php
 */
...
class TaskSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('DzTask\Entity\Task');
    }
     ...
     * @return null
     */
    function it_has_a_rw_description()
    {
        $description = 'test';
     ...
     * @return null
     */
    function it_returns_itself_when_setting_description()
    {
